        ...
        if($request->get('email')){
            ...
            if($user) {
                ...
                // 2 : Envoyer un email à l'utilisateur avec un lien en lui permettant de mettre a jour son mot de passe
                    ...
                    $content = "Bonjour ".$user->getFullName()."<br>Vous avez demandé à réinitialiser votre mot de passe sur le site La Boutique Française.<br><br>";
                    $content .= "Merci de bien vouloir cliquer sur le lien suivant pour <a href='".$url."'>mettre à jour votre mot de passe</a>.";

                    $mail = new Mail();
                    $mail->send(htmlentities($user->getEmail()),htmlentities($user->getFullName()), 'Réinitialiser votre mot de passe sur La Boutique Française',htmlentities($content));
                    $this->addFlash('notice',
                                    'Vous allez recevoir dans quelques secondes un mail afin de 
                                            ...
                                            penser à vérifier dans les spamms');
